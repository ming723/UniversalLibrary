...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     * 设置红线
     */
    public void setLineStyle(float size) {
        mTabStrip.setLineStyle(mViewPager.getAdapter(), size);
        setTitleColor(0);
    }
...
//            viewPager.setOnPageChangeListener(new InternalViewPagerListener());
    ...
    protected void setTitleColor(int position) {
        for (int i = 0; i < mTabStrip.getChildCount(); i++) {
            TextView v = (TextView) mTabStrip.getChildAt(i);
            if (position == i) {
                v.setTextColor(Color.parseColor("#da251d"));
            } else {
