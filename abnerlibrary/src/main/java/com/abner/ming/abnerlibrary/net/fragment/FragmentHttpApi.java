 ...
 * Api管理类
 */
public abstract class FragmentHttpApi extends FragmentBaseApi{
    ...
    public FragmentHttpApi(HttpOnNextListener listener, RxAppCompatDialogFragment rxAppCompatActivity) {
